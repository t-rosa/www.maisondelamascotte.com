...
export function Hero() {
  return (
    <section
      id='hero'
      className='grid h-[calc(100vh-8rem)] items-center px-3 sm:px-10 md:px-14 lg:px-20'
    >
      <picture className='relative h-full border-2 border-indigo-300 dark:border-indigo-400'>
        ...
        <div className='relative font-allura grid h-full place-items-center'>
          <div>
            <h1 className='shrink-0 font-allura text-4xl tracking-tight sm:text-6xl md:text-7xl lg:text-8xl text-black'>
